...
export const GraphicProjectTypeByPeriod = ({ userData }) => {
    ...
    const chartDataPrepared = monthsInRange.map(({ mes, ano }) => {
        ...
        const allTypes = ["realidade aumentada", "machine learning", "internet das coisas", "desenvolvimento web", "inteligência artificial", "desenvolvimento de software", "saas", "cloud computing", "automação de processos", "segurança de ti"]; // ou os tipos de projeto reais; // ou os tipos de projeto reais; // ou os tipos de projeto reais
    ...
    const generateChartConfig = () => {
        ...
        types.forEach((type, index) => {
            config[type.toLowerCase()] = {
                label: type,
                color: `hsl(${index * 10000}, 70%, 50%)`, // Gera cores diferentes para os tipos de projetos
            };
        });
